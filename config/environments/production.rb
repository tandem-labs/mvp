...
Rails.application.configure do
  ...
  config.consider_all_requests_local = ENV["SHOW_MAILER_PREVIEWS"] || false
  ...
  # config.active_job.queue_name_prefix = "tandem_labs_mvp_#{Rails.env}"
  ...
  config.action_mailer.show_previews = ENV["SHOW_MAILER_PREVIEWS"] || false
